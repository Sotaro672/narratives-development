...
func (u *ProductUsecase) Update(ctx context.Context, id string, p productdom.Product) (productdom.Product, error) {
	return u.repo.Update(ctx, strings.TrimSpace(id), p)
}
