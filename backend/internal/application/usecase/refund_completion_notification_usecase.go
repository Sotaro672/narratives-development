...
type RefundCompletionNotificationUsecase struct {
	deliveryRepo RefundCompletionNotificationRepositoryPort
	authUser     applicationport.AuthUserReader
	mailer       RefundCompletionNotificationMailerPort
	queue        RefundCompletionNotificationQueuePort
...
func (u *RefundCompletionNotificationUsecase) Process(
	...
	result, sendErr :=
		u.mailer.SendRefundCompletionNotification(
			ctx,
			RefundCompletionNotificationMailMessage{
