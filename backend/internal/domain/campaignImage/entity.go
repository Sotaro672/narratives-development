...
// CampaignImagesTableDDL defines the SQL for the campaign_images table.
const CampaignImagesTableDDL = `
CREATE TABLE IF NOT EXISTS campaign_images (
  ...
  CHECK (mime_type IS NULL OR mime_type ~* '^[A-Za-z0-9.+-]+/[A-Za-z0-9.+-]+$')
);
