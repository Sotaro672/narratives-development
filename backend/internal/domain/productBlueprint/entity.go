...
func WrapInvalid(err error, message string) error {
	if err == nil {
		return fmt.Errorf(
			"%w: %s",
			ErrInvalid,
...
func IsValidTagType(value ProductIDTagType) bool {
	switch value {
	case TagQR, TagNFC:
		return true
	default:
...
func validateCategoryFieldsStructure(fields CategoryFields) error {
...
func cloneCategoryFields(fields CategoryFields) CategoryFields {
	if fields == nil {
		return nil
	}
	cloned := make(
...
func normalizeExistingModelRefs(refs []ModelRef) []ModelRef {
	copied := append(
		[]ModelRef(nil),
		refs...,
	)
...
func validateModelRefs(refs []ModelRef) error {
	seen := make(
		map[string]struct{},
		len(refs),
	)
...
func (productBlueprint ProductBlueprint) CanModify() bool {
...
func (productBlueprint *ProductBlueprint) MarkPrinted(now time.Time, updatedBy *string, categoryFieldsValidator CategoryFieldsValidator) error {
...
// Update methods
// ======================================
func (productBlueprint *ProductBlueprint) UpdateProductName(productName string, now time.Time, updatedBy *string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
...
// 空文字は説明文を削除する操作を表します。
func (productBlueprint *ProductBlueprint) UpdateDescription(description string, now time.Time, updatedBy *string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
...
func (productBlueprint *ProductBlueprint) UpdateBrand(brandID string, now time.Time, updatedBy *string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
...
func (productBlueprint *ProductBlueprint) UpdateCategoryFields(fields CategoryFields, categoryFieldsValidator CategoryFieldsValidator, now time.Time, updatedBy *string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
...
func (productBlueprint *ProductBlueprint) UpdateAssignee(assigneeID string, now time.Time, updatedBy *string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
...
func (productBlueprint *ProductBlueprint) UpdateTag(tag ProductIDTag, now time.Time, updatedBy *string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
...
func (productBlueprint *ProductBlueprint) UpdateModelIDs(modelIDs []string, now time.Time, updatedBy *string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
	...
	productBlueprint.ModelRefs = normalizeModelRefs(modelIDs)
	productBlueprint.touch(
		now,
		updatedBy,
	)
...
// 印刷後の追記は禁止します。
func (productBlueprint *ProductBlueprint) AppendModelIDsNoTouch(modelIDs []string) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
	...
	productBlueprint.ModelRefs = mergeAndRenumberModelRefs(
...
// UpdatedAtとUpdatedByは変更しません。
// 印刷後の同期は禁止します。
func (productBlueprint *ProductBlueprint) ReplaceModelRefsWithoutTouch(refs []ModelRef) error {
	if productBlueprint == nil {
		return ErrInvalid
	}
	if !productBlueprint.canModify() {
	...
	productBlueprint.ModelRefs = normalizeExistingModelRefs(refs)
	return nil
}
...
func (productBlueprint ProductBlueprint) Validate() error {
	return productBlueprint.validate()
}

// ValidateCategoryFieldsは現在のカテゴリに対して
// CategoryFieldsのschema検証を実行します。
func (productBlueprint ProductBlueprint) ValidateCategoryFields(categoryFieldsValidator CategoryFieldsValidator) error {
	if err := productBlueprint.validate(); err != nil {
		return err
	}
...
func (productBlueprint ProductBlueprint) validate() error {
	...
	if err := productBlueprint.ProductIdTag.validate(); err != nil {
		return err
	}
...
// Helpers
// ======================================
func (productBlueprint *ProductBlueprint) touch(now time.Time, updatedBy *string) {
	if now.IsZero() {
		now = time.Now().UTC()
	}
	productBlueprint.UpdatedAt = now.UTC()
	productBlueprint.UpdatedBy = updatedBy
}
