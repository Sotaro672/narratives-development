...
type repos struct {
	...
	reportDecisionNotificationRepo    *fs.ReportDecisionNotificationRepositoryFS
	...
	tokenBlueprintCreateOperationRepo *fs.TokenBlueprintCreateOperationRepositoryFS
...
func buildRepos(c *clients) *repos {
	...
	reportDecisionNotificationRepo := fs.NewReportDecisionNotificationRepositoryFS(fsClient)
	...
	tokenBlueprintCreateOperationRepo := fs.NewTokenBlueprintCreateOperationRepositoryFS(fsClient)
	...
	return &repos{
		...
		tokenBlueprintCreateOperationRepo: tokenBlueprintCreateOperationRepo,
