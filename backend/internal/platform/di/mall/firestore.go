// backend/internal/platform/di/mall/firestore.go
package mall
...
// ============================================================
// Optional: TB patch reader used by some queries (kept here only if it is Firestore-backed)
// ============================================================

type tbPatchByIDFS struct {
	repo interface {
		GetPatchByID(ctx context.Context, id string) (tbdom.Patch, error)
	}
}

func (a *tbPatchByIDFS) GetPatchByID(ctx context.Context, id string) (tbdom.Patch, error) {
	if a == nil || a.repo == nil {
		return tbdom.Patch{}, errors.New("tbPatchByIDFS: repo is nil")
	}
