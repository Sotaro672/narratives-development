...
const mfOptions = {
  ...
  remotes: {
    ...
    inquiries: "http://localhost:4004/assets/remoteEntry.js",

    listings: "http://localhost:4005/assets/remoteEntry.js",
    operations: "http://localhost:4006/assets/remoteEntry.js",
    ...
    orders: "http://localhost:4011/assets/remoteEntry.js",
    ads: "http://localhost:4012/assets/remoteEntry.js",
    accounts: "http://localhost:4013/assets/remoteEntry.js",
    transactions: "http://localhost:4014/assets/remoteEntry.js",
