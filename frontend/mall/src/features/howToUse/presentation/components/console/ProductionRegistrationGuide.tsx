  ...
  return (
    <>
      <HowToUseSection title="生産計画作成画面の開け方">
        ...
        <HowToUseVideo storagePath="console/production-registration/go-to-production-registration.mp4" label="商品生産一覧を開き、生産計画を作成ボタンから生産計画作成画面へ移動する手順" />
      </HowToUseSection>
      ...
      <HowToUseSection title="生産数の入力">
        ...
        <HowToUseVideo storagePath="console/production-registration/enter-production-quantity.mp4" label="ブランドと商品設計を選択し、モデル別生産数一覧で各モデルの生産数を入力する手順" />
      </HowToUseSection>
      ...
      <HowToUseSection title="商品の印刷">
        ...
        <HowToUseVideo storagePath="console/production-registration/print-product.mp4" label="保存した生産計画から商品の印刷を実行する手順" />
      </HowToUseSection>
      ...
      <HowToUseSection title="印刷結果の確認">
        ...
        <HowToUseVideo storagePath="console/production-registration/view-print-result.mp4" label="商品の印刷後に印刷結果を確認し、QRコード出力とCSV出力を確認する手順" />
      </HowToUseSection>
    </>
  );
}