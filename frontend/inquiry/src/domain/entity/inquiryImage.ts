// frontend/inquiry/src/domain/entity/inquiryImage.ts

/**
 * inquiryImage / ImageFile domain
 * backend/internal/domain/inquiryImage/entity.go に対応するフロントエンド側定義。
 *
 * Firestore / API 層との I/O や UI バリデーションの共通型として利用する想定。
 */
