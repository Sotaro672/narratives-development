 ...
 * createdBy / updatedByはConsoleから登録・更新された場合のみ、 
 * members document IDを保持する。 
 * User側で登録された配送先住所では未設定を許可する。 
 */ 
 ...
 * 
 * id、userId、companyId、createdBy、updatedByはBackend側または既存entityから解決するため、 
 ...
 * createdBy / updatedByもUser側では未設定を許可する。 
 */ 
 ...
 * 配送先住所の入力項目を更新する。 
 * 
 * id、userId、companyId、createdAt、createdBy、updatedByは変更しない。 
 * updatedByはConsole Backendが認証contextのmember document IDから更新する。 
 */ 
