...
export default function ListDetail() {
  ...
  const effectiveTransportationOption = isEdit
    ? vm.draftTransportationOption
    : vm.transportationOption;

  const effectiveTransportationId = isEdit
    ? vm.draftTransportationId
    : vm.transportationId;
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <TransportOptionCard
          options={vm.transportationOptions}
          transportationOption={effectiveTransportationOption}
          transportationId={effectiveTransportationId}
          onSelectTransportationOption={
            isEdit
              ? vm.onSelectTransportationOption
              : () => {}
          }
          setTransportationId={
            isEdit
              ? vm.setDraftTransportationId
              : () => {}
          }
          loading={vm.loading}
        />
