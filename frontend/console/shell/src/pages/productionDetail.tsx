...
import ProductionQuantityCard from "../../../production/presentation/components/productionQuantityCard";

import { useProductionDetail } from "../../../production/presentation/hook/useProductionDetail";
...
import { usePrintCard } from "../../../product/presentation/hook/usePrintCard";

// 分離した印刷カードコンポーネント
import PrintCard from "../../../product/presentation/component/printCard";

// Presentation 正: ProductionQuantityRowVM（キーは modelId）
import type { ProductionQuantityRowVM } from "../../../production/presentation/viewModels/productionQuantityRowVM";
