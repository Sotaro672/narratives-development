...
export type UseProductBlueprintVariationsParams = {
  ...
  initialState?:
    | Partial<ProductBlueprintVariationsState>
    | null;
};

export type UseProductBlueprintVariationsResult =
...
function createEmptyVariationsState():
  ProductBlueprintVariationsState {
  return {
    colors: [],
    colorRgbMap: {},
...
export function useProductBlueprintVariations(
  params:
    UseProductBlueprintVariationsParams = {},
): UseProductBlueprintVariationsResult {
  const initialStateRef =
    React.useRef<
      ProductBlueprintVariationsState
    >(
      normalizeVariationsState(
        params.initialState,
      ),
    );
  ...
  const [
    ...
    React.useState<ProductBlueprintVariationsState>(
  ...
  const measurementOptions =
    ...
    >(
      () => {
        if (
          !isApparelMeasurementCategoryCode(
            categoryCode,
          )
        ) {
          return [];
