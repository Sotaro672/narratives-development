 ...
 */ 
export async function updateInventoryTransportationRaw( 
  inventoryId: string, 
  ...
  if ( 
    ...
    throw new Error( 
      "transportationOption is invalid", 
    ); 
  } 
  ...
  if ( 
    ...
    throw new Error( 
      "transportationId is required for custom transportation", 
    ); 
  } 
 
  return patchJsonOrThrow( 
    `/inventory/${encodeURIComponent(id)}/transportation`, 
    { 
      transportationOption: 
        option, 
      transportationId: 
