 ...
 * kind 指定でカテゴリ一覧を取得する。
 *
 * GET /console/product-blueprint-categories?kind=apparel
 * GET /console/product-blueprint-categories?kind=alcohol
 * GET /console/product-blueprint-categories?kind=cosmetics
 * GET /console/product-blueprint-categories?kind=healthcare
 * GET /console/product-blueprint-categories?kind=other
 */
 ...
 * code 指定でカテゴリを1件取得する。
 *
 * backend handler 自体には GetByCode route はなく、
 * List の query param code で絞り込む構成。
 */
